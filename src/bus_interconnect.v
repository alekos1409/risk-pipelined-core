module bus_interconnect(address,data_in,MemWriteM, data_data_memory,
 data_UART,address_data_memory,address_UART,MemWriteM_data_memory,
 MemWriteM_UART,ReadDataM,data_out,UART_busy);
    input [31:0]address;

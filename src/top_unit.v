...
module top_unit(clk,reset);
input clk;
input reset;
reg [31:0] pc;
wire [31:0]rd_data,rs2_data,rs1_data,imm_out,result,data_out,pc_next,alu_b,instruction,zero,slt;
wire ALUSrc,MemToReg,MemWrite,MemRead,Branch,Jump,RegWrite;
wire [1:0]ALUOp;
wire [2:0]ALUcontrol;
